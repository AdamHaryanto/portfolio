                                ...
                                case 'unity':
                                  return (
                                    <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
                                      <path d="M10.086 12L6.387 18.353 4.56 12l1.829-6.353L10.086 12zm1.77 1.014L15.6 19.667h-7.49l3.748-6.653zm0-2.028L8.11 4.333h7.49l-3.746 6.653zM19.44 12l-5.846 10.2-1.746-3.018 4.092-7.182-4.092-7.182 1.746-3.018L19.44 12z" />
                                    </svg>
                                  );
                                case 'roblox':
                                  return (
